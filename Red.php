<html>
<head><link href="estilo de temario.css" rel="stylesheet" type="text/css"></head>
<body background="f3.jpg" style="background-repeat: no-repeat; background-position: center center;">
  <div>
      <ul>
...
<p> <p> <p> <p> <p> <p> <p> <p> <p> 
  ...
  <h1 style="color: #FFFFFF; ">CONTESTA LO QUE SE TE PIDE 
  <p>1.-¿Qué es un Switch?</p>
  <input id="radios" type="radio" name="radioS" value="">Te permite conectar otros dispositivos y compartir su información.<br>
  <input id="radios" type="radio" name="radioS" value="">Conecta diversos tipos de equipos entre si.<br>
  <input id="radios" type="radio" name="radioS" value="">Dispositivo que conecta diferentes equipos dentro de una misma RED.<br>
  <input id="radios" type="radio" name="radioS" value="">Se encarga de llear por una ruta adecuada el trafico de información.  <br> <br>

  <p>2.-¿cuales son los tipos de Redes sin contar la logica?</p>
  ...
  <input id="caja" type="checkbox" name="check[]" value="RAM">RAM  <br> <br>
  ...
  <input type="reset" value="Imprimir PDF">
